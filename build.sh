...
${nuget_cmd} install src/com.tweirtx.TBAV3/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/com.tweirtx.TBAV3.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/com.tweirtx.TBAV3.dll \
-recurse:'src/com.tweirtx.TBAV3/*.cs' \
-doc:bin/com.tweirtx.TBAV3.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/com.tweirtx.TBAV3.dll was created successfully"
fi
