...
${nuget_cmd} install src/com.tweirtx.tba-api-v3-client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/com.tweirtx.tba-api-v3-client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/com.tweirtx.tba-api-v3-client.dll \
-recurse:'src/com.tweirtx.tba-api-v3-client/*.cs' \
-doc:bin/com.tweirtx.tba-api-v3-client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/com.tweirtx.tba-api-v3-client.dll was created successfully"
fi
