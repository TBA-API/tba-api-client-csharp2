...
namespace com.tweirtx.TBAAPIv3client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MatchAlliances :  IEquatable<MatchAlliances>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchAlliances" /> class.
        /// </summary>
        /// <param name="red">red.</param>
        /// <param name="blue">blue.</param>
        public MatchAlliances(MatchAlliance red = default(MatchAlliance), MatchAlliance blue = default(MatchAlliance))
        {
            this.Red = red;
            this.Blue = blue;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MatchAlliances {\n");
        ...
        {
            return this.Equals(input as MatchAlliances);
        }

        /// <summary>
        /// Returns true if MatchAlliances instances are equal
        /// </summary>
        /// <param name="input">Instance of MatchAlliances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatchAlliances input)
        {
            if (input == null)
                return false;
