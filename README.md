# com.tweirtx.tba-api-v3-client - the C# library for the The Blue Alliance API v3
...
```
nuget pack -Build -OutputDirectory out com.tweirtx.tba-api-v3-client.csproj
```
...
## Documentation for Models
 ...
 - [Model.EventPredictions](docs/EventPredictions.md)
